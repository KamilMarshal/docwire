        ...
        <div className="docwire__haveyouever">
            <div className="docwire__haveyouever-section padding">
                ...
                <ul role="list" className="list">
                    ...
                    <li className="list-item">Automatically parse through and extract important data from incoming emails,
                        such as customer information or order details?
                    </li>
                    <li className="list-item">Parse through a large amount of documents and extract specific data points,
                        such as dates, names, or product numbers, with ease?
                    </li>
                    <li className="list-item">Utilize the OCR technology to recognize and extract text from various sources,
                ...
                <h2 className="docwire__haveyouever-h2">
                    ...
                    for fast and accurate data extraction and document parsing. Whether you need to extract data from invoices,
                    forms, or any other document, our data extraction SDK will revolutionize the way you extract and manage data.
